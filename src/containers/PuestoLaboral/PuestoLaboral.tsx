...
const PuestoLaboral = () => {
  return (
    ...
    < Box sx={{p:2, pt: 0}}>
      ...
      <Grid item xs={12} sx={{mb:2}}>
      <TextField fullWidth label="Profesión" name="profesion" size="small" />
      </Grid>
