...
const SolidaridadLista = () => {

    const {params, setParams} = useApiParams();  
    const {data} = useQuery(['solidaridades', params], () => SolidaridadAPI.getAll(params), {keepPreviousData: true});                         
    ...
    const refresh = () => {
        queryClient.invalidateQueries('solidaridades');
    }
    ...
    return (
        <>
            <TituloContainer>Solidaridades</TituloContainer>
...
export default SolidaridadLista
